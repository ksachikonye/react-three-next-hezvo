...
const useStore = create((set, get) => {
  const drums = createAudio('/Cohesion.mp3', { threshold: 10, expire: 500 })
  const snare = createAudio('/Cohesion.mp3', { threshold: 40, expire: 500 })
  const synth = createAudio('/Cohesion.mp3')
  return {
    loaded: false,
    clicked: false,
